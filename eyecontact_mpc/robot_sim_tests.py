...
filename = ("./simulation results/%s-%s-%s_%s-%s-%s.txt" % (t_now.year, t_now.month, t_now.day, t_now.hour, t_now.minute, t_now.second) )
...
for i in range(num_steps):
    ...
    # if 0 == (np.random.randint(int(round(5./dt)))):
    #     u[1] = round(1.-u[1])
